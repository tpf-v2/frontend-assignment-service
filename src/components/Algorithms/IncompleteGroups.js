    ...
    <Box sx={{ padding: 4 }}>
      <Grid container spacing={2}>
        ...
        <Grid item xs={12} sx={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
          ...
          <TableContainer component={Paper} style={{ marginTop: "20px", maxHeight: "400px", flexGrow: 1 }}>
            <Table stickyHeader>
              <TableHead>
                <TableRow>
          ...
          {/* Botón de "Ver más información de los grupos" a la derecha */}
          <Box sx={{ display: 'flex', alignItems: 'center', marginLeft: '16px' }}>
            <Button variant="outlined" onClick={() => navigate(`/dashboard/${period.id}/groups`)}>
